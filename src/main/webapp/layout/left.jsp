...
<script type="text/javascript">
	...
	$(function() {
		...
		$("td.Depth03:contains('판매상품등록')").on(
				"click",
				function() {
					$(window.parent.frames["rightFrame"].document.location)
							.attr("href", "../product/addProductView.jsp");
				})
		$("td.Depth03:contains('판매상품관리')").on(
				"click",
				function() {
					$(window.parent.frames["rightFrame"].document.location)
							.attr("href", "/product/listProduct/manage");
				})
		$("td.Depth03:contains('배송 관리')").on(
				"click",
				function() {
					$(window.parent.frames["rightFrame"].document.location)
							.attr("href", "/purchase/listDelivery");
				})
		$("td.Depth03:contains('상 품 검 색')").on(
				"click",
				function() {
					$(window.parent.frames["rightFrame"].document.location)
							.attr("href", "/product/listProduct/search");
				})
		$("td.Depth03:contains('구매이력조회')").on(
				"click",
				function() {
					$(window.parent.frames["rightFrame"].document.location)
							.attr("href", "/purchase/listPurchase");
				})
		$("td.Depth03:contains('장바구니')").on(
				"click",
				function() {
					$(window.parent.frames["rightFrame"].document.location)
		...
		/* $("td.Depth03:contains('최근 본 상품')").mouseenter(function(){
			 $(this).css("font-size", "20px");
		}).mouseleave(function(){
			 $(this).css("font-size", $("body").css("font-size"));
		}).on("click",function(){
					...
					<tr>
						<c:if test="${ !empty user }">
							...
							////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
									...
									target="rightFrame">개인정보조회</a>  --> 개인정보조회
								</td>
							</tr>
						</c:if>
					...
					<table border="0" cellspacing="0" cellpadding="0" width="159">
						<tr>
							<td class="Depth03">
								...
								target="rightFrame">판매상품등록</a> -->판매상품등록
							</td>
						</tr>
						<tr>
							<td class="Depth03">
								<!-- <a href="/product/listProduct/manage"
								target="rightFrame"> -->판매상품관리</a>
							</td>
						</tr>
						<tr>
							<td class="Depth03">
								<!-- <a href="/purchase/listDelivery"
								target="rightFrame"> -->배송 관리</a>
							</td>
						</tr>
						<tr>
							<td class="DepthEnd">&nbsp;</td>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="159">
					<tr>
						<td class="Depth03">
							...
							target="rightFrame">상 품 검 색</a> -->상 품 검 색
						</td>
					</tr>
					...
					<c:if test="${ !empty user && user.role == 'user'}">
						<tr>
							<td class="Depth03">
								...
								target="rightFrame">구매이력조회</a> -->구매이력조회
							</td>
						</tr>
						<tr>
							<td class="Depth03">
								<!-- <a href="/basket/listBasket"
								target="rightFrame">장바구니</a> -->장바구니
							</td>
						</tr>
					</c:if>
